...
//
const DWORD TRANSFORMED_VERTEX::FVF = D3DFVF_XYZRHW;
const DWORD UNTRANSFORMED_VERTEX::FVF = D3DFVF_XYZ;
const DWORD UNTRANSFORMED_LIT_VERTEX::FVF = (D3DFVF_XYZ|D3DFVF_DIFFUSE|D3DFVF_SPECULAR);
const DWORD UNTRANSFORMED_UNLIT_VERTEX::FVF =
	(D3DFVF_XYZ|D3DFVF_NORMAL|D3DFVF_DIFFUSE|D3DFVF_SPECULAR);		
const DWORD COLORED_TEXTURED_VERTEX::FVF = (D3DFVF_XYZ|D3DFVF_DIFFUSE|D3DFVF_TEX1);
const DWORD COLORED_VERTEX::FVF = (D3DFVF_XYZ|D3DFVF_DIFFUSE);
const DWORD TEXTURED_VERTEX::FVF = D3DFVF_XYZ | D3DFVF_NORMAL | D3DFVF_TEX1;
